  ...
  function exportar($datos, $fechaInicio, $fechaFin){
    ...
    echo "<table>
            ...
            for ($i=0; $i <count($datos) ; $i++) {
              echo "<tr>
                        <td align='center' style='vertical-align:middle'>".$datos[$i]["PLAZA"]."</td>
                        <td align='center' style='vertical-align:middle'>".$datos[$i]["PROCESO"]."</td>
                        <td style='vertical-align:middle'>".$datos[$i]["DESCRIPCION"]."</td>
                        <td style='vertical-align:middle'>".$datos[$i]["EMISOR"]."</td>
